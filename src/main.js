...
// }
console.log('%celelee test:', 'background:#000;color:#fff', '更新');
...
import dotMark from '@c/dotMark';
import iconPulldown from '@c/iconPulldown';

Vue.config.productionTip = false

Vue.prototype.$anime = window.anime = anime;

Vue.component('dotMark', dotMark);
Vue.component('iconPulldown', iconPulldown);
